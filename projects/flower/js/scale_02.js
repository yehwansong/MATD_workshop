...
// POSITION
    ...
    // $('.img_'+i).css({top:'2%', bottom:'0',left:'25%',margin:'-'+($('img_').height() / 2)+'px 0 0 -'+($('img_').width() / 2)+'px'});
...
// GENERATOR
    ...
    $('.img_'+i).css({'transform':'rotate('+(360/30)*i+'deg) scale('+(i%2+3)/4+')'}) //scale('+(i%2+0.5)/3+') 
