...
// POSITION
    ...
    // $('.img_'+i).css({top:'12%', bottom:'0',left:'25%',margin:'-'+($('img_').height() / 2)+'px 0 0 -'+($('img_').width() / 2)+'px'});
...
// GENERATOR
    ...
    $('.img_'+i).css({'transform':'rotate('+(360/100)*i+'deg)  translateX('+i*3+'px)'})
