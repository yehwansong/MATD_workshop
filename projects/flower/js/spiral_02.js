...
// POSITION
    ...
    // $('.img_'+i).css({bottom:'45vh',left:'36%',margin:'-'+($('img_').height() / 2)+'px 0 0 -'+($('img_').width() / 2)+'px'});
...
// GENERATOR
    ...
    $('.img_'+i).css({'transform':'rotate('+(360/30)*i+'deg) scale('+(i%2+5)/5+') translateX('+i*2+'px)'})
