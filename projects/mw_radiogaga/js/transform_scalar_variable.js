                ...
                if(pre_value!==value){
                           ...
                           var min_translate_x = 0
                            ...
                            var wdth
                                    ...
                                    wght = map_range(value,0,100,min_wght,max_wght)
                                    wdth = map_range(value,0,100,min_wdth,max_wdth)
                                    $('.wrapper').eq(localcounter).find('.element').css({'transform':'translate('+translate_x+'px, '+translate_y+'px) skew('+skew_x+'deg, '+skew_y+'deg) rotate('+rotation+'deg) scale('+scale_x+', '+scale_y+')'})
                                     $('.wrapper').eq(localcounter).find('.element').css({'font-variation-settings':' "wght" '+wght+', "wdth" '+wdth})
                                    pre_value=value
