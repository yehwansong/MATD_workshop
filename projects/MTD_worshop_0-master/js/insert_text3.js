...
counter_init++
        ready = true
        $('.division_1').append('<div class="wrapper wrapper_'+counter_init+' wrapper_text_4"></div>')
        for (var i = 0; i < text_4.split('').length; i++) {
            $('.division_1 .wrapper_'+counter_init).append("<span class='element '>"+text_4.split('')[i]+"</span>")
